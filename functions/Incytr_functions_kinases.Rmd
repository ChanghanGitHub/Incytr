---
title: "Incytr_functions_kinases"
author: "Changhan"
date: "2024-05-12"
...
#' motifGene -- kinase, gene -- substrate

#' Calculate the exclusiveness index (EI) for each gene
#' @param df a data frame of gene expression in each cell group, rownames = genes
#' @param cell_group a character of cell group names
#' @param fold_threshold a numarical value, the default number is 10
...
#' Requirement for the kinase data: must have variables 'gene', 'site_pos', and 'motif.geneName'
#' @param kldata a data frame of kinase data: must have variables 'gene', 'site_pos', and 'motif.geneName'
#' @param df a data frame of gene expression in each cell group, rownames = genes
#' @param cell_group a character of cell group names
#' @param fold_threshold a numarical value, the default number is 10
